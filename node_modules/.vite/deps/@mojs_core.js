      ...
      var t2 = { 50: (t3, e3, s2) => {
        ...
        var r2 = s2(2), i = { _sample: function(t4) {
          ...
          if ("number" === s3) {
            ...
            n2[0] = t4(0);
            for (var h = 0; h < o - 1; h++) a += l, n2[parseFloat(a.toFixed(e4))] = t4(a);
            n2[1] = t4(1), n2.base = e4;
          } else "object" === s3 ? n2 = e4 : "string" === s3 && (n2 = JSON.parse(e4));
        ...
        const l = function() {
          ...
          return (0, n.Z)(t4, [{ key: "_declareDefaults", value: function() {
            ...
            if ("object" === (0, r2.Z)(t5)) for (var s3 in t5) this._assignProp(s3, t5[s3]);
            else this._assignProp(t5, e4);
            ...
            var s3 = e4;
            if (this._arrayPropertyMap[t5]) switch (s3 = [], (0, r2.Z)(e4)) {
              case "number":
                s3.push(o().parseUnit(e4));
                break;
              case "string":
                for (var i2 = e4.split(" "), n2 = 0; n2 < i2.length; n2++) s3.push(o().parseUnit(i2[n2]));
            }
            return s3;
            ...
            for (var e4 in this._hide(), t5) t5 && delete this._deltas[e4], this._o[e4] = t5[e4], this._parseOption(e4, t5[e4]);
            ...
            for (var s3 in this._deltas) {
              ...
              if ("array" === r3.type) {
                ...
                this._props[s3] = a2;
              } else if ("number" === r3.type) this._props[s3] = i2 ? r3.curve(e4) * (r3.start + e4 * r3.delta) : r3.start + n2 * r3.delta;
                ...
                } else d = parseInt(r3.start.r + n2 * r3.delta.r, 10), _ = parseInt(r3.start.g + n2 * r3.delta.g, 10), f = parseInt(r3.start.b + n2 * r3.delta.b, 10), v = parseFloat(r3.start.a + n2 * r3.delta.a);
        ...
        function p(t4) {
          ...
          return function() {
            ...
            } else s3 = r3.apply(this, arguments);
        ...
        const c = function(t4) {
          ...
          return (0, n.Z)(s3, [{ key: "_declareDefaults", value: function() {
            ...
            for (var e5 = 0, s4 = 1; s4 < t5.length; s4++) e5 += this._pointsDelta(t5[s4 - 1], t5[s4]);
        ...
        const u = function(t4) {
          ...
          return (0, i.Z)(s3, [{ key: "_declareDefaults", value: function() {
            ...
            for (var t5 = 0; t5 < this._drawMap.length; t5++) "stroke-width" === this._drawMap[t5] && this._drawMap.splice(t5, 1);
        ...
        const d = function(t4) {
          ...
          return (0, i.Z)(s3, [{ key: "add", value: function() {
            for (var t5 = arguments.length, e5 = new Array(t5), s4 = 0; s4 < t5; s4++) e5[s4] = arguments[s4];
            ...
            for (var t5 = 0; t5 < this._timelines.length; t5++) this._timelines[t5].reset();
          } }, { key: "_stopChildren", value: function(t5) {
            for (var e5 = this._timelines.length - 1; e5 >= 0; e5--) this._timelines[e5].stop(t5);
          } }, { key: "_appendTimelineArray", value: function(t5) {
            for (var e5 = t5.length, s4 = this._props.repeatTime - this._props.delay, r3 = this._timelines.length; e5--; ) this._appendTimeline(t5[e5], r3, s4);
            ...
            for (var e5 = this._timelines.length, r3 = 0; r3 < e5; r3++) this._timelines[r3]._refresh(t5);
        ...
        const _ = function(t4) {
          ...
          return (0, i.Z)(s3, [{ key: "_declareDefaults", value: function() {
            ...
            if (i2.speed && this._playTime && (t5 = this._playTime + i2.speed * (t5 - this._playTime)), Math.abs(i2.endTime - t5) < 1e-8 && (t5 = i2.endTime), r3 && null != s4) {
              ...
              if (this._timelines) for (var l2 = 0; l2 < this._timelines.length; l2++) this._timelines[l2]._update(t5, e5, s4, r3);
            ...
            if (t5 === e5.endTime) return this._wasUknownUpdate = false, u2 = e5.isYoyo && (a2 - 1) % 2 == 1, this._setProgress(u2 ? 0 : 1, t5, u2), t5 > this._prevTime && (this._isRepeatCompleted = false), this._repeatComplete(t5, u2), this._complete(t5, u2);
            ...
            if (this.progress = t5, n2 && !s4 || !n2 && s4) this.easedProgress = r3.easing(t5);
            else if (!n2 && !s4 || n2 && s4) {
        ...
        const n = new (function() {
          ...
          return (0, i.Z)(t4, [{ key: "_vars", value: function() {
            ...
            for (var t5 = 0; t5 < this._savedTweens.length; t5++) this._savedTweens[t5].pause();
          } }, { key: "_restorePlayingTweens", value: function() {
            for (var t5 = 0; t5 < this._savedTweens.length; t5++) this._savedTweens[t5].resume();
          } }]), t4;
        }())();
      }, 977: (t3, e3, s2) => {
        var r2, i;
        i = s2(52), r2 = new class {
          ...
          generate(t4, e4, s3, r3) {
            ...
            return t4 < 0 || t4 > 1 || s3 < 0 || s3 > 1 ? this.error("Bezier x values should be > 0 and < 1") : (y = 0.1, c = !!Float32Array, i2 = function(t5, e5) {
              ...
              var i3;
              for (f = 0; f < 4; ) {
                if (0 === (i3 = d(r4, t4, s3))) return r4;
                r4 -= (h(r4, t4, s3) - e5) / i3, ++f;
              }
              return r4;
            }, u = function() {
              for (f = 0; f < 11; ) m[f] = h(f * y, t4, s3), ++f;
            }, l = function(e5, r4, i3) {
              var n2, a2;
        ...
        s2 = null, n = function(t4) {
          ...
          var s3, r3, i2;
          for (s3 = r3 = 0, i2 = t4.length; r3 < i2; s3 = ++r3) if (t4[s3].to > e4) return s3;
        }, i = function(...t4) {
        ...
        i = s2(52), r2 = class t4 {
          ...
          constructor(t5, e4 = {}) {
            if (this.o = e4, "creator" !== t5) {
              if (this.path = i.parsePath(t5), null == this.path) return i.error("Error while parsing the path");
          ...
          _preSample() {
            ...
            for (this._samples = [], a = [], t5 = e4 = 0, n = this._precompute; 0 <= n ? e4 <= n : e4 >= n; t5 = 0 <= n ? ++e4 : --e4) i2 = t5 * this._step, s3 = this.pathLength * i2, r3 = this.path.getPointAtLength(s3), a.push(this._samples[t5] = { point: r3, length: s3, progress: i2 });
            return a;
          }
          _findBounds(t5, e4) {
            var s3, r3, i2, n, a, o, l, h, u, p, c, d, _;
            if (e4 === this._boundsPrevProgress) return this._prevBounds;
          ...
          _checkIfPointCloseEnough(t5, e4) {
            if (i.closeEnough(t5, e4.x / this._rect, this._eps)) return this._resolveY(e4);
          }
          ...
          _joinNormalizedPath(t5, e4) {
            var s3, r3, i2, n;
            for (n = "", s3 = r3 = 0, i2 = t5.length; r3 < i2; s3 = ++r3) n += `${0 === s3 ? "" : " "}${t5[s3]}${e4[s3].trim()}`;
            return n;
          }
          _normalizeSegment(t5, e4 = 0) {
            var s3, r3, i2, n, a, o, l, h;
            if (t5 = t5.trim(), a = /(-|\+)?((\d+(\.(\d|\e(-|\+)?)+)?)|(\.?(\d|\e|(\-|\+))+))/gim, h = (i2 = (o = this._getSegmentPairs(t5.match(a)))[o.length - 1])[0], Number(h) !== e4) for (t5 = "", i2[0] = e4, s3 = r3 = 0, n = o.length; r3 < n; s3 = ++r3) t5 += `${0 === s3 ? "" : " "}${(l = o[s3])[0]},${l[1]}`;
            return t5;
          }
          _getSegmentPairs(t5) {
            var e4, s3, r3, n, a;
            for (t5.length % 2 != 0 && i.error("Failed to parse the path - segment pairs are not even.", t5), n = [], e4 = s3 = 0, r3 = t5.length; s3 < r3; e4 = s3 += 2) t5[e4], a = [t5[e4], t5[e4 + 1]], n.push(a);
            return n;
          }
          create(e4, s3) {
            var r3;
        ...
        e3 = (function() {
          class t4 {
            ...
            cloneObj(t5, e4) {
              var s3, r2, i, n;
              for (n = {}, s3 = (i = Object.keys(t5)).length; s3--; ) r2 = i[s3], null != e4 && e4[r2] || (n[r2] = t5[r2]);
              return n;
            }
            extend(t5, e4) {
              var s3;
              for (s3 in e4) e4[s3], null == t5[s3] && (t5[s3] = e4[s3]);
              return t5;
            }
            getRemBase() {
              var t5, e4;
            ...
            style(t5, e4, s3) {
              var r2, i, n, a;
              if ("object" == typeof e4) {
                for (n = (i = Object.keys(e4)).length, a = []; n--; ) s3 = e4[r2 = i[n]], a.push(this.setPrefixedStyle(t5, r2, s3));
                return a;
              }
            ...
            log() {
              if (false !== mojs.isDebug) return console.log.apply(console, this.prepareForLog(arguments));
            }
            warn() {
              if (false !== mojs.isDebug) return console.warn.apply(console, this.prepareForLog(arguments));
            }
            error() {
              if (false !== mojs.isDebug) return console.error.apply(console, this.prepareForLog(arguments));
            }
            parseUnit(t5) {
              var e4, s3, r2, i, n;
            ...
            calcArrDelta(t5, e4) {
              var s3, r2, i, n;
              for (s3 = [], r2 = i = 0, n = t5.length; i < n; r2 = ++i) t5[r2], s3[r2] = this.parseUnit(`${e4[r2].value - t5[r2].value}${e4[r2].unit}`);
              return s3;
            }
            isArray(t5) {
            ...
            normDashArrays(t5, e4) {
              ...
              if ((s3 = t5.length) > (r2 = e4.length)) for (l = s3 - r2, p = e4.length, n = a = 0, h = l; 0 <= h ? a < h : a > h; n = 0 <= h ? ++a : --a) i = n + p, e4.push(this.parseUnit(`0${t5[i].unit}`));
              else if (r2 > s3) for (l = r2 - s3, p = t5.length, n = o = 0, u = l; 0 <= u ? o < u : o > u; n = 0 <= u ? ++o : --o) i = n + p, t5.push(this.parseUnit(`0${e4[i].unit}`));
              return [t5, e4];
            }
            makeColorObj(t5) {
            ...
            capitalize(t5) {
              if ("string" != typeof t5) throw Error("String expected - nothing to capitalize");
            ...
            parseDelta(t5, e4, s3) {
              ...
              if (null != (n = (e4 = this.cloneObj(e4)).easing) && (n = mojs.easing.parseEasing(n)), delete e4.easing, null != (r2 = e4.curve) && (r2 = mojs.easing.parseEasing(r2)), delete e4.curve, a = e4[c = Object.keys(e4)[0]], i = { start: c }, !isNaN(parseFloat(c)) || c.match(/rand\(/) || c.match(/stagger\(/)) if ("strokeDasharray" === t5 || "strokeDashoffset" === t5 || "origin" === t5) {
                for (d = this.strToArr(c), o = this.strToArr(a), this.normDashArrays(d, o), h = u = 0, p = d.length; u < p; h = ++u) c = d[h], a = o[h], this.mergeUnits(c, a, t5);
                i = { type: "array", name: t5, start: d, end: o, delta: this.calcArrDelta(d, o), easing: n, curve: r2 };
              } else this.callbacksMap[t5] || this.tweenOptionMap[t5] || (this.unitOptionMap[t5] ? (a = this.parseUnit(this.parseStringOption(a, s3)), c = this.parseUnit(this.parseStringOption(c, s3)), this.mergeUnits(c, a, t5), i = { type: "unit", name: t5, start: c, end: a, delta: a.value - c.value, easing: n, curve: r2 }) : (a = parseFloat(this.parseStringOption(a, s3)), i = { type: "number", name: t5, start: c = parseFloat(this.parseStringOption(c, s3)), end: a, delta: a - c, easing: n, curve: r2 }));
              else {
                if ("strokeLinecap" === t5) return this.warn(`Sorry, stroke-linecap property is not animatable yet, using the start(${c}) value instead`, e4), i;
            ...
            getChildElements(t5) {
              var e4, s3, r2;
              for (s3 = [], r2 = (e4 = t5.childNodes).length; r2--; ) 1 === e4[r2].nodeType && s3.unshift(e4[r2]);
              return s3;
            }
            delta(t5, e4) {
              var s3, r2, i, n, a;
              if (a = typeof e4, s3 = "string" == (n = typeof t5) || "number" === n && !isNaN(t5), r2 = "string" === a || "number" === a && !isNaN(e4), s3 && r2) return (i = {})[t5] = e4, i;
    ...
    <feMerge>
      ...
      <feMergeNode in="blur2"></feMergeNode>
            ...
            run(t5) {
              var e4, s3;
              if (t5) {
                for (e4 in this.history[0], t5) s3 = t5[e4], a.callbacksMap[e4] || a.tweenOptionMap[e4] ? (a.warn(`the property "${e4}" property can not be overridden on run yet`), delete t5[e4]) : this.history[0][e4] = s3;
                this.tuneOptions(t5);
              }
            ...
            createTween() {
              return this.tween = new n({ duration: this.props.duration, delay: this.props.delay, yoyo: this.props.yoyo, repeat: this.props.repeat, easing: this.props.easing, onStart: () => {
                ...
                if (!t5) return this.history.length > 1 && this.tuneOptions(this.history[0]);
            ...
            _setTransformOrigin(t5) {
              var e4;
              if (this.props.transformOrigin) return e4 = "function" == typeof this.props.transformOrigin ? this.props.transformOrigin(this.rotate, t5) : this.props.transformOrigin, a.setPrefixedStyle(this.el, "transform-origin", e4);
            }
            ...
            setBlur(t5) {
              if (!this.isMotionBlurReset) return this.filter.setAttribute("stdDeviation", `${t5.blur.x},${t5.blur.y}`), this.filterOffset.setAttribute("dx", t5.offset.x), this.filterOffset.setAttribute("dy", t5.offset.y);
            }
            extendDefaults(t5) {
              var e4, s3, r3;
              for (e4 in s3 = [], t5) r3 = t5[e4], s3.push(this[e4] = r3);
              return s3;
            }
            extendOptions(t5) {
              var e4, s3, r3;
              for (e4 in s3 = [], t5) r3 = t5[e4], s3.push(this.props[e4] = r3);
              return s3;
            }
            then(t5) {
              var e4, s3, r3, i2, o2;
              for (s3 in r3 = {}, i2 = this.history[this.history.length - 1]) o2 = i2[s3], !a.callbacksMap[s3] && !a.tweenOptionMap[s3] || "duration" === s3 ? null == t5[s3] && (t5[s3] = o2) : null == t5[s3] && (t5[s3] = void 0), a.tweenOptionMap[s3] && (r3[s3] = "duration" !== s3 || null != t5[s3] ? t5[s3] : i2[s3]);
        ...
        r2 = s2(623).Z, i = class extends r2 {
          ...
          _draw() {
            ...
            if (super._draw(), this._props, r3 = null != this._props.radiusX ? this._props.radiusX : this._props.radius, i2 = null != this._props.radiusY ? this._props.radiusY : this._props.radius, e4 = r3 === this._prevRadiusX, s3 = i2 === this._prevRadiusY, !e4 || !s3) return t4 = `M${(n = this._props.width / 2) - r3},${a = this._props.height / 2} L${n + r3},${a} M${n},${a - i2} L${n},${a + i2}`, this.el.setAttribute("d", t4), this._prevRadiusX = r3, this._prevRadiusY = i2;
          }
          _getLength() {
        ...
        r2 = s2(623).Z, i = class extends r2 {
          ...
          _draw() {
            ...
            if (super._draw(), a = this._props, this._props.points && (o = null != this._props.radiusX ? this._props.radiusX : this._props.radius, l = null != this._props.radiusY ? this._props.radiusY : this._props.radius, r3 = o === this._prevRadiusX, i2 = l === this._prevRadiusY, s3 = a.points === this._prevPoints, !(r3 && i2 && s3))) {
              for (u = this._props.width / 2, d = this._props.height / 2, p = u - o, c = u + o, t4 = "", f = 2 * l / (this._props.points - 1), _ = d - l, e4 = n = 0, h = this._props.points; 0 <= h ? n < h : n > h; e4 = 0 <= h ? ++n : --n) t4 += `M${p}, ${d = `${e4 * f + _}`} L${c}, ${d} `;
        ...
        n = s2(52), r2 = s2(623).Z, i = class extends r2 {
          ...
          _draw() {
            ...
            if (h = this._props, p = null != this._props.radiusX ? this._props.radiusX : this._props.radius, c = null != this._props.radiusY ? this._props.radiusY : this._props.radius, r3 = p === this._prevRadiusX, i2 = c === this._prevRadiusY, s3 = h.points === this._prevPoints, !(r3 && i2 && s3)) {
              for (f = 360 / this._props.points, null == this._radialPoints ? this._radialPoints = [] : this._radialPoints.length = 0, e4 = a = 0, d = this._props.points; 0 <= d ? a < d : a > d; e4 = 0 <= d ? ++a : --a) this._radialPoints.push(n.getRadialPoint({ radius: this._props.radius, radiusX: this._props.radiusX, radiusY: this._props.radiusY, rotate: e4 * f, center: { x: h.width / 2, y: h.height / 2 } }));
              for (t4 = "", e4 = o = 0, l = (_ = this._radialPoints).length; o < l; e4 = ++o) t4 += `${0 === e4 ? "M" : "L"}${(u = _[e4]).x.toFixed(4)},${u.y.toFixed(4)} `;
        ...
        r2 = s2(623).Z, i = class extends r2 {
          ...
          _draw() {
            ...
            if (super._draw(), l = this._props, this._props.points && (u = null != this._props.radiusX ? this._props.radiusX : this._props.radius, p = null != this._props.radiusY ? this._props.radiusY : this._props.radius, i2 = u === this._prevRadiusX, n = p === this._prevRadiusY, r3 = l.points === this._prevPoints, !(i2 && n && r3))) {
              for (t4 = l.width / 2 - u, e4 = _ = l.height / 2, d = 2 * u / (l.points - 1), f = -1, o = -(s3 = Math.sqrt(d * d + p * p)), h = `M${t4}, ${_} `, a = 0, c = l.points; 0 <= c ? a < c : a > c; 0 <= c ? ++a : --a) h += `L${t4}, ${e4} `, t4 += d, o += s3, e4 = -1 === f ? _ - p : _, f = -f;
        ...
        r2 = class {
          ...
          redefineProto() {
            ...
            return e4 = this, (function() {
              var r3, i, n, a;
              for (n = this.allowedProtos, a = [], t4 = r3 = 0, i = n.length; r3 < i; t4 = ++r3) null != (s3 = n[t4]).prototype && a.push(function(t5) {
                return function(s4) {
                  var r4;
                  r4 = function() {
          ...
          initTimer(t4) {
            ...
            return s3 = 0, e4 = 0, this.interval = setInterval(() => {
              var r3, i;
              if (i = t4.offsetWidth, r3 = t4.offsetHeight, i !== s3 || r3 !== e4) return this.dispatchEvent(t4), s3 = i, e4 = r3;
          ...
          destroy() {
            var t4, e4, s3, r3, i, n;
            for (clearInterval(this.interval), this.interval = null, window.isAnyResizeEventInited = false, n = [], t4 = e4 = 0, s3 = (i = this.allowedProtos).length; e4 < s3; t4 = ++e4) null != (r3 = i[t4]).prototype && n.push(function(t5) {
        ...
        function n(t4, e4) {
          if (e4 && ("object" === (0, r2.Z)(e4) || "function" == typeof e4)) return e4;
        ...
        function i(t4) {
          var e4 = function(t5, e5) {
            if ("object" !== (0, r2.Z)(t5) || null === t5) return t5;
      ...
      s.n = (t3) => {
        ...
        for (var r2 in e3) s.o(e3, r2) && !s.o(t3, r2) && Object.defineProperty(t3, r2, { enumerable: true, get: e3[r2] });
      ...
      return (() => {
        ...
        function y(t4) {
          ...
          return function() {
            ...
            } else s2 = r2.apply(this, arguments);
        ...
        var k = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "then", value: function(t5) {
            if (null == t5 || !Object.keys(t5).length) return 1;
            ...
            for (var s3 in this._arrayPropertyMap) if (this._o[s3]) {
            ...
            if (e3().isTweenProp(t5) || this._nonMergeProps[t5] || a2) return r3;
            if (e3().isObject(r3) && null != r3.to && (i2 = r3.curve, n2 = r3.easing, r3 = r3.to), this._isDelta(r3)) return this._parseDeltaValues(t5, r3);
        ...
        var S = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "tune", value: function(t5) {
            if (t5 && Object.keys(t5).length) {
              for (var s3 in this._transformHistory(t5), this._tuneNewOptions(t5), this._history[0] = e3().cloneObj(this._props), this._arrayPropertyMap) null != t5[s3] && (this._history[0][s3] = this._preparsePropValue(s3, t5[s3]));
            ...
            if (0 === t5) {
              if (i2[s3] = r3, e3().isTweenProp(s3) && "duration" !== s3) return null;
            ...
            if (null == s3 && null != t5) return false;
            ...
            for (var t5 = 1; t5 < this._modules.length; t5++) this._modules[t5]._tuneNewOptions(this._history[t5]);
        ...
        var x = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "then", value: function(t5) {
            ...
            for (var e4 = 0; e4 < this._modules.length; e4++) this._modules[e4].then(this._getOptionByIndex(e4, t5));
            return this.timeline._recalcTotalDuration(), this;
          } }, { key: "tune", value: function(t5) {
            if (null == t5) return this;
            for (var e4 = 0; e4 < this._modules.length; e4++) this._modules[e4].tune(this._getOptionByIndex(e4, t5));
            return this.timeline._recalcTotalDuration(), this;
          } }, { key: "generate", value: function() {
            for (var t5 = 0; t5 < this._modules.length; t5++) this._modules[t5].generate();
            return this.timeline._recalcTotalDuration(), this;
        ...
        var D = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "_declareDefaults", value: function() {
            ...
            if ((0, _.Z)((0, u.Z)(r2.prototype), "_tuneNewOptions", this).call(this, t5), null == t5 || !Object.keys(t5).length) return 1;
            this._setElStyles();
            ...
            for (var t5 = 0, e4 = 0, s3 = 0; s3 < this._modules.length; s3++) this._modules[s3]._getShapeSize(), t5 = Math.max(t5, this._modules[s3]._props.shapeWidth), e4 = Math.max(e4, this._modules[s3]._props.shapeHeight);
            ...
            for (var t5 = this._props, e4 = "", s3 = 0; s3 < t5.origin.length; s3++) e4 += "".concat(t5.origin[s3].string, " ");
            return e4;
        ...
        const L = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "_declareDefaults", value: function() {
            ...
            if (s3) return delete this._deltas[t5], { start: s3.start.value, end: s3.end.value, delta: s3.delta, units: s3.end.unit };
        ...
        var I = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "_declareDefaults", value: function() {
            ...
            for (var s3 in e3().tweenOptionMap) null == this._defaults[s3] && delete t5[s3];
            ...
            var s3 = {};
            for (var r3 in t5.children) s3[r3] = this._getPropByMod(r3, e4, t5.children);
            return s3;
        ...
        var X = function() {
          ...
          return (0, o.Z)(t4, [{ key: "refresh", value: function(t5) {
            ...
            } else r2 = parseInt(o2.r + e4 * l2.r, 10), i2 = parseInt(o2.g + e4 * l2.g, 10), n2 = parseInt(o2.b + e4 * l2.b, 10), a2 = parseFloat(o2.a + e4 * l2.a);
        ...
        var q = H._defaults, V = function() {
          ...
          return (0, o.Z)(t4, [{ key: "refresh", value: function(t5) {
            for (var e4 = 0; e4 < this._deltas.length; e4++) this._deltas[e4].refresh(t5);
            return this;
          } }, { key: "restore", value: function() {
            for (var t5 = 0; t5 < this._deltas.length; t5++) this._deltas[t5].restore();
            return this;
          } }, { key: "_createTimeline", value: function() {
            ...
            if ("strokeLinecap" === t5) return e3().warn("Sorry, stroke-linecap property is not animatable yet, using the start(#{start}) value instead", s2), {};
        ...
        var st = J._defaults, rt = function(t4) {
          ...
          return (0, o.Z)(r2, [{ key: "_declareDefaults", value: function() {
            ...
            for (var t5 in this._customProps) null == this._o[t5] && (this._o[t5] = this._customProps[t5]);
          } }, { key: "_resetMergedFlags", value: function(t5) {
            ...
            for (var e4 = "", s3 = 0; s3 < t5.length; s3++) e4 += "".concat(t5[s3].string, " ");
            return e4;
          } }, { key: "_addDefaults", value: function(t5) {
            for (var e4 in this._is3d = false, this._defaults) null == t5[e4] ? t5[e4] = "scaleX" === e4 || "scaleY" === e4 ? null != t5.scale ? t5.scale : this._defaults.scale : this._defaults[e4] : -1 !== this._3dProperties.indexOf(e4) && (this._is3d = true);
            ...
            if (e3().isTweenProp(t5) || this._nonMergeProps[t5] || i2) return r3;
            var n2 = {};
            if (e3().isObject(r3) && null != r3.to) {
              for (var a2 in r3) (st[a2] || "curve" === a2) && (n2[a2] = r3[a2], delete r3[a2]);
              r3 = r3.to;
            }
            if (this._isDelta(r3)) {
              var o2 = {};
              for (var l2 in r3) (st[l2] || "curve" === l2) && (o2[l2] = r3[l2], delete r3[l2]);
